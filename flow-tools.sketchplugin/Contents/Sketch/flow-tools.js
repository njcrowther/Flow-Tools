...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/flow-tools.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  selection.forEach(function (selected) {
    ...
    var artboardWidth = selected.frame.width; // Create new text layer: here's where I make it fixedWidth and bottom aligned
    ...
    newText.style.verticalAlignment = Text.VerticalAlignment.bottom; // Left align text box with artboard

    selected.selected = true;
    newText.selected = true; // Vertical position of the text layer with the artboard
